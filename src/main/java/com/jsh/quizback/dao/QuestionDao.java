...
public interface QuestionDao extends PagingAndSortingRepository<Question,Integer> {
	...
	@Modifying
	@Query(value = "INSERT INTO QUESTION_QUIZ (id_quiz,id_question) VALUES (?1,?2)", nativeQuery = true)
	@Transactional
	public void saveQuestionQuiz(@Param("idQuiz") Integer idQuiz, @Param("idQuestion") Integer idQuestion);
